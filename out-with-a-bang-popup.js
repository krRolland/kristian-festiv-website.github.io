    ...
    blumIMDB = "https://www.imdb.com/name/nm0089781/"; 
    kulikIMDB = "https://www.imdb.com/name/nm3752434/";
    ...
    blumSourceSet = "images/alan-blumenfeld.png 500w, images/alan-blumenfeld.png 800w, images/alan-blumenfeld.png 1080w, images/alan-blumenfeld.png 1280w";
    kulikSourceSet = "images/art-kulik.png 500w, images/art-kulik.png 800w, images/art-kulik.png 1080w, images/art-kulik.png 1280w";
    ...
    blumElem = document.getElementsByClassName("blum-link")[0]; 
    kulikElem = document.getElementsByClassName("kulik-link")[0];
    ...
    hoverOverGray = false; 
    hoverOverBlum = false; 
    hoverOverKulik = false;
    
    //Include this
    hoverOverPopup = false; 

    hoverArray = [hoverOverPeeblerOne, hoverOverPeeblerTwo, hoverOverErez, hoverOverGray, hoverOverBlum, hoverOverKulik];
    ...
    peeblerOneElem.addEventListener('mouseleave', function() {
      ...
      setTimeout(function () {if(!hoverOverPeeblerOne && !hoverOverPeeblerTwo && !hoverOverErez && !hoverOverGray && !hoverOverBlum && hoverOverKulik) {fadeOutHover();}} , 400);
      }); 
    ...
    // BLUM
    blumElem.addEventListener('mouseenter', function() {hoverOverBlum = true;}); 
    blumElem.addEventListener('mouseleave', function() {
      hoverOverBlum = false;
      setTimeout(function () {if(!hoverOverPeeblerOne && !hoverOverPeeblerTwo && !hoverOverErez && !hoverOverGray && !hoverOverBlum && hoverOverKulik) {fadeOutHover();}} , 400);
      }); 

    // KULIK
    kulikElem.addEventListener('mouseenter', function() {hoverOverKulik = true;}); 
    kulikElem.addEventListener('mouseleave', function() {
      hoverOverKulik = false;
      setTimeout(function () {if(!hoverOverPeeblerOne && !hoverOverPeeblerTwo && !hoverOverErez && !hoverOverGray && !hoverOverBlum && hoverOverKulik) {fadeOutHover();}} , 400);
      }); 
    ...
    function triggerHover() {
      ...
      if (this.classList.contains("gray-link")) {
        ...
        hoverPopup.style.top = (grayElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
      ...
      // IF BLUM
      if (this.classList.contains("blum-link")) {
        imgToReplace.srcset = blumSourceSet; 
        imdbLink.href = blumIMDB;
        followMeName.innerHTML = "ALAN BLUMENFELD";
        hoverPopup.style.top = (blumElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
          if(!hoverOverBlum && !hoverOverPopup) {fadeOutHover();}
        }, 500);
      } 

      // IF KULIK
      if (this.classList.contains("kulik-link")) {
        imgToReplace.srcset = kulikSourceSet; 
        imdbLink.href = kulikIMDB;
        followMeName.innerHTML = "ART KULIK";
        hoverPopup.style.top = (kulikElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
          if(!hoverOverKulik && !hoverOverPopup) {fadeOutHover();}
        }, 500);
      }
    ...
    blumElem.addEventListener('mouseenter', triggerHover);
    kulikElem.addEventListener('mouseenter', triggerHover);
