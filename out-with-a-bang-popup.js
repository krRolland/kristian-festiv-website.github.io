...
// ******************** BLUM ********************
// STEP 1: MAKE A SHOW POPUP FUNCTION FOR EACH STAR
function hoverOverBlum() {
  queuedIMDB = "https://www.imdb.com/name/nm0089781/";
  queuedSourceSet = "images/alan-blumenfeld.png 500w, images/alan-blumenfeld.png 800w, images/alan-blumenfeld.png 1080w, images/alan-blumenfeld.png 1280w";
  queuedName = "ALAN BLUMENFELD";
  queuedVerticalCoord = (this.offsetTop + 25).toString() + "px";
  // Horizontal coordinate depends on mobile version
  if (window.mobileCheck()) {
    queuedHorizontalCoord = "15px";          	
...
blumElem.addEventListener('mouseenter', hoverOverBlum);
blumElem.addEventListener('mouseleave', hoverAwayForEachStar);

// ******************** KULIK ********************
// STEP 1: MAKE A SHOW POPUP FUNCTION FOR EACH STAR
function hoverOverKulik() {
  queuedIMDB = "https://www.imdb.com/name/nm3752434/";
  queuedSourceSet = "images/art-kulik.png 500w, images/art-kulik.png 800w, images/art-kulik.png 1080w, images/art-kulik.png 1280w";
  queuedName = "ART KULIK";
  queuedVerticalCoord = (this.offsetTop + 25).toString() + "px";
  // Horizontal coordinate depends on mobile version
  if (window.mobileCheck()) {
    queuedHorizontalCoord = "15px";          	
...
kulikElem.addEventListener('mouseenter', hoverOverKulik);
kulikElem.addEventListener('mouseleave', hoverAwayForEachStar);