    ...
    function triggerHover() {
      ...
      if (this.classList.contains("erez-link-one")) {
        ...
        hoverPopup.style.top = (erezOneElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
      ...
      if (this.classList.contains("erez-link-two")) {
        ...
        imdbLink.href = erezIMDB;
        followMeName.innerHTML = "MARC FELLNER-EREZ";
        hoverPopup.style.top = (erezTwoElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
      ...
      if (this.classList.contains("wilson-link")) {
        ...
        hoverPopup.style.top = (wilsonElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
      ...
      if (this.classList.contains("snell-link")) {
        ...
        hoverPopup.style.top = (snellElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
      ...
      if (this.classList.contains("samp-link")) {
        ...
        hoverPopup.style.top = (sampElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
      ...
      if (this.classList.contains("tobias-link")) {
        ...
        hoverPopup.style.top = (tobiasElem.offsetTop + 25).toString() + "px";
        setTimeout(function() {
