...
// ******************** SHIELDS ********************
// STEP 1: MAKE A SHOW POPUP FUNCTION FOR EACH STAR
function hoverOverShields() {
  queuedIMDB = "https://www.imdb.com/name/nm3710442/";
  queuedSourceSet = "images/Unknown-Photo.png 500w, images/Unknown-Photo.png 800w, images/Unknown-Photo.png 1080w, images/Unknown-Photo.png 1280w";
  queuedName = "STEVEN SHIELDS";
  queuedVerticalCoord = (this.offsetTop + 25).toString() + "px";
  // Horizontal coordinate depends on mobile version
  if (window.mobileCheck()) {
    queuedHorizontalCoord = "15px";          	
...
shieldsElem.addEventListener('mouseenter', hoverOverShields);
shieldsElem.addEventListener('mouseleave', hoverAwayForEachStar);

// ******************** PHIL ********************
// STEP 1: MAKE A SHOW POPUP FUNCTION FOR EACH STAR
function hoverOverPhil() {
...
philElem.addEventListener('mouseenter', hoverOverPhil);
philElem.addEventListener('mouseleave', hoverAwayForEachStar);

// ******************** SKYE ********************
// STEP 1: MAKE A SHOW POPUP FUNCTION FOR EACH STAR
function hoverOverSkye() {
  queuedIMDB = "https://www.imdb.com/name/nm3019061/";
  queuedSourceSet = "images/Unknown-Photo.png 500w, images/Unknown-Photo.png 800w, images/Unknown-Photo.png 1080w, images/Unknown-Photo.png 1280w";
  queuedName = "ARI SKYE";
  queuedVerticalCoord = (this.offsetTop + 25).toString() + "px";
  // Horizontal coordinate depends on mobile version
...
skyeElem.addEventListener('mouseenter', hoverOverSkye);
skyeElem.addEventListener('mouseleave', hoverAwayForEachStar);